...
public class ProductAnalytics {
    ...
    /**
     * คืนค่า "ชื่อ" ของสินค้าทั้งหมดที่มีราคาต่ำกว่าที่กำหนด map เป็นชื่อ เเล้วลิส
     * 
     */
    ...
    /**
     * คำนวณมูลค่ารวมของสต็อกสินค้าในหมวดหมู่ที่กำหนด เลือกหมู่เเละเอา ราคา กับ จำนวนคูณ
     */
    ...
    public double calculateTotalStockValueForCategory(String category) {
    return productCatalog.stream()
    .filter(p -> p.category().equalsIgnoreCase(category)) //เอาตัวตรงกัน
